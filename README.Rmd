...
It is under construction, a lot of functions are/will be deprecated, some of them will be moved to other packages (like anything useful and related to plotting with `ggplot2` will got to [`sciplotr`](https://github.com/Ilia-Kosenkov/sciplotr)).
